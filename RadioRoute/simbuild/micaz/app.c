...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c09458, const void *arg_0xb7c095f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7bba8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a64840), 
int (*key_eq_fn)(void *arg_0xb7a64c88, void *arg_0xb7a64e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79339b8, int arg_0xb7933b10);
static double RandomUniform(void );
...
# 24 "RadioRouteC.nc"
routing_table_entry_t RadioRouteC$routingTable[1000][7];
...
uint16_t RadioRouteC$index_led[1000][8];

uint8_t RadioRouteC$num_msg[1000];

bool RadioRouteC$trovato[1000];
uint8_t RadioRouteC$check[1000];
uint8_t RadioRouteC$t[1000];
uint8_t RadioRouteC$j[1000];
uint8_t RadioRouteC$z[1000];
uint8_t RadioRouteC$i[1000];
uint8_t RadioRouteC$k[1000];
uint8_t RadioRouteC$p[1000];

uint8_t RadioRouteC$r[1000];


uint8_t RadioRouteC$resto[1000];
uint8_t RadioRouteC$destinazione[1000];
uint8_t RadioRouteC$firstdestination[1000];
uint8_t RadioRouteC$count_path_received_node_1[1000];
uint8_t RadioRouteC$min_count_path_received_node_1[1000];
uint8_t RadioRouteC$sender_min_count_path_received_node_1[1000];

bool RadioRouteC$route_req_sent[1000];
bool RadioRouteC$route_rep_sent[1000];
bool RadioRouteC$locked[1000];
bool RadioRouteC$fine[1000];
...
static inline void RadioRouteC$fillRoutingTable(void );
static uint8_t RadioRouteC$routeTableCheck(uint16_t dest);
static inline void RadioRouteC$ledSequence(void );
...
{
  LedsP$Led2$toggle();
  sim_log_debug(196U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 116
  ;
}
...
static inline void RadioRouteC$ledSequence(void )
{
  RadioRouteC$k[sim_node()] = 0;
  while (RadioRouteC$k[sim_node()] < 8) 
    {
      RadioRouteC$resto[sim_node()] = RadioRouteC$leader_code[sim_node()][RadioRouteC$k[sim_node()]] % 3;
      RadioRouteC$index_led[sim_node()][RadioRouteC$k[sim_node()]] = RadioRouteC$resto[sim_node()];
      RadioRouteC$k[sim_node()] = RadioRouteC$k[sim_node()] + 1;
    }
}
...
#line 264
  ...
  if (TOS_NODE_ID == 6) 
    {
      RadioRouteC$ledSequence();




      if (RadioRouteC$index_led[sim_node()][RadioRouteC$num_msg[sim_node()] % 8] == 0) 
        {
          RadioRouteC$Leds$led0Toggle();
          RadioRouteC$num_msg[sim_node()] = RadioRouteC$num_msg[sim_node()] + 1;
          sim_log_debug_clear(155U, "radio_rec", "\n");
          sim_log_debug(156U, "radio_rec", "Resto 0 - Node %d\n", TOS_NODE_ID);
          sim_log_debug(157U, "led_0", "Led 0 status %u\n", (RadioRouteC$Leds$get() & LEDS_LED0) > 0);
          sim_log_debug(158U, "led_1", "Led 1 status %u\n", (RadioRouteC$Leds$get() & LEDS_LED1) > 0);
          sim_log_debug(159U, "led_2", "Led 2 status %u\n", (RadioRouteC$Leds$get() & LEDS_LED2) > 0);
        }
      else {
#line 286
        if (RadioRouteC$index_led[sim_node()][RadioRouteC$num_msg[sim_node()] % 8] == 1) 
          {
            RadioRouteC$Leds$led1Toggle();
            RadioRouteC$num_msg[sim_node()] = RadioRouteC$num_msg[sim_node()] + 1;
            sim_log_debug_clear(160U, "radio_rec", "\n");
            sim_log_debug(161U, "radio_rec", "Resto 1 - Node %d\n", TOS_NODE_ID);
            sim_log_debug(162U, "led_0", "Led 0 status %u\n", (RadioRouteC$Leds$get() & LEDS_LED0) > 0);
            sim_log_debug(163U, "led_1", "Led 1 status %u\n", (RadioRouteC$Leds$get() & LEDS_LED1) > 0);
            sim_log_debug(164U, "led_2", "Led 2 status %u\n", (RadioRouteC$Leds$get() & LEDS_LED2) > 0);
          }
        else {
#line 296
          if (RadioRouteC$index_led[sim_node()][RadioRouteC$num_msg[sim_node()] % 8] == 2) 
            {
              RadioRouteC$Leds$led2Toggle();
              RadioRouteC$num_msg[sim_node()] = RadioRouteC$num_msg[sim_node()] + 1;
              sim_log_debug_clear(165U, "radio_rec", "\n");
              sim_log_debug(166U, "radio_rec", "Resto 2 - Node %d\n", TOS_NODE_ID);
              sim_log_debug(167U, "led_0", "Led 0 status %u\n", (RadioRouteC$Leds$get() & LEDS_LED0) > 0);
              sim_log_debug(168U, "led_1", "Led 1 status %u\n", (RadioRouteC$Leds$get() & LEDS_LED1) > 0);
              sim_log_debug(169U, "led_2", "Led 2 status %u\n", (RadioRouteC$Leds$get() & LEDS_LED2) > 0);
            }
          }
        }
#line 306
      sim_log_debug(170U, "radio", "Messages received and sent from node 6: %d\n\n", RadioRouteC$num_msg[sim_node()]);
    }


  if (__nesc_ntoh_uint8(rrm->type.nxdata) == 1 && !RadioRouteC$fine[sim_node()]) 
    {
      sim_log_debug(171U, "radio_rec", "Received a ROUTE_REQ at time %s\n", sim_time_string());
      RadioRouteC$check[sim_node()] = RadioRouteC$routeTableCheck(__nesc_ntoh_uint8(rrm->dest.nxdata));



      if (RadioRouteC$check[sim_node()] == 9 && TOS_NODE_ID != __nesc_ntoh_uint8(rrm->dest.nxdata)) 
        {
          __nesc_hton_uint8(rrm->sender.nxdata, TOS_NODE_ID);
          RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, 1);
          sim_log_debug(172U, "radio_send", "Sending a ROUTE_REQ in broadcast\n");
        }



      if (TOS_NODE_ID == __nesc_ntoh_uint8(rrm->dest.nxdata)) 
        {
          __nesc_hton_uint8(rrm->type.nxdata, 2);
          __nesc_hton_uint8(rrm->sender.nxdata, TOS_NODE_ID);
          __nesc_hton_uint8(rrm->data.nxdata, 1);
          sim_log_debug(173U, "radio_send", "I am the destination, set cost to 1 and send a ROUTE_REPLY in broadcast\n");
          RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, __nesc_ntoh_uint8(rrm->type.nxdata));
        }




      if (RadioRouteC$check[sim_node()] <= 6 && RadioRouteC$check[sim_node()] >= 0) 
        {
          RadioRouteC$j[sim_node()] = 0;
          RadioRouteC$trovato[sim_node()] = FALSE;
          while (RadioRouteC$j[sim_node()] < 7 && RadioRouteC$trovato[sim_node()] == FALSE) 
            {
              if (RadioRouteC$routingTable[sim_node()][RadioRouteC$j[sim_node()]].destAddress == __nesc_ntoh_uint8(rrm->dest.nxdata)) 
                {
                  __nesc_hton_uint8(rrm->data.nxdata, RadioRouteC$routingTable[sim_node()][RadioRouteC$j[sim_node()]].cost + 1);
                  RadioRouteC$trovato[sim_node()] = TRUE;
                }
              RadioRouteC$j[sim_node()] = RadioRouteC$j[sim_node()] + 1;
            }
          __nesc_hton_uint8(rrm->type.nxdata, 2);
          __nesc_hton_uint8(rrm->sender.nxdata, TOS_NODE_ID);
          RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, __nesc_ntoh_uint8(rrm->type.nxdata));
          sim_log_debug(174U, "radio_send", "Sending a ROUTE_REP in broadcast\n");
        }
    }


  if (__nesc_ntoh_uint8(rrm->type.nxdata) == 2 && !RadioRouteC$fine[sim_node()] && TOS_NODE_ID != __nesc_ntoh_uint8(rrm->dest.nxdata)) 
    {
      sim_log_debug(175U, "radio_rec", "Received a ROUTE_REPLY at time %s\n", sim_time_string());
      RadioRouteC$check[sim_node()] = RadioRouteC$routeTableCheck(__nesc_ntoh_uint8(rrm->dest.nxdata));


      if (TOS_NODE_ID == 1 && RadioRouteC$routeTableCheck(7)) 
        {
          RadioRouteC$count_path_received_node_1[sim_node()] = RadioRouteC$count_path_received_node_1[sim_node()] + 1;
          if (__nesc_ntoh_uint8(rrm->data.nxdata) < RadioRouteC$min_count_path_received_node_1[sim_node()]) 
            {
              RadioRouteC$min_count_path_received_node_1[sim_node()] = __nesc_ntoh_uint8(rrm->data.nxdata);
              RadioRouteC$sender_min_count_path_received_node_1[sim_node()] = __nesc_ntoh_uint8(rrm->sender.nxdata);
            }
          if (RadioRouteC$count_path_received_node_1[sim_node()] == 2) 
            {
              RadioRouteC$firstdestination[sim_node()] = RadioRouteC$sender_min_count_path_received_node_1[sim_node()];
              sim_log_debug(176U, "radio_send", "<<<<< Route found, cost: %d, send packet from 1 to %d \n", RadioRouteC$min_count_path_received_node_1[sim_node()], RadioRouteC$firstdestination[sim_node()]);

              __nesc_hton_uint8(rrm->type.nxdata, 0);
              __nesc_hton_uint8(rrm->dest.nxdata, 7);
              __nesc_hton_uint8(rrm->data.nxdata, 5);
              __nesc_hton_uint8(rrm->sender.nxdata, TOS_NODE_ID);
              RadioRouteC$generate_send(RadioRouteC$firstdestination[sim_node()], bufPtr, 0);
            }
        }
      else {
#line 385
        if (RadioRouteC$check[sim_node()] == 9) 
          {
            RadioRouteC$t[sim_node()] = 0;
            while (RadioRouteC$routingTable[sim_node()][RadioRouteC$t[sim_node()]].destAddress != 0) 
              {
                RadioRouteC$t[sim_node()] = RadioRouteC$t[sim_node()] + 1;
              }

            RadioRouteC$routingTable[sim_node()][RadioRouteC$t[sim_node()]].destAddress = __nesc_ntoh_uint8(rrm->dest.nxdata);
            RadioRouteC$routingTable[sim_node()][RadioRouteC$t[sim_node()]].nextHop = __nesc_ntoh_uint8(rrm->sender.nxdata);
            RadioRouteC$routingTable[sim_node()][RadioRouteC$t[sim_node()]].cost = __nesc_ntoh_uint8(rrm->data.nxdata);
            __nesc_hton_uint8(rrm->data.nxdata, __nesc_ntoh_uint8(rrm->data.nxdata) + 1);
            __nesc_hton_uint8(rrm->sender.nxdata, TOS_NODE_ID);
            RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, 2);
            sim_log_debug(177U, "radio_send", "Sending a ROUTE_REPLY in broadcast\n");
          }
        else 
          {
            RadioRouteC$z[sim_node()] = 0;
            while (RadioRouteC$routingTable[sim_node()][RadioRouteC$z[sim_node()]].destAddress != __nesc_ntoh_uint8(rrm->dest.nxdata)) 
              {
                RadioRouteC$z[sim_node()] = RadioRouteC$z[sim_node()] + 1;
              }
            if (__nesc_ntoh_uint8(rrm->data.nxdata) < RadioRouteC$routingTable[sim_node()][RadioRouteC$z[sim_node()]].cost) 
              {
                RadioRouteC$routingTable[sim_node()][RadioRouteC$z[sim_node()]].cost = __nesc_ntoh_uint8(rrm->data.nxdata);
                RadioRouteC$routingTable[sim_node()][RadioRouteC$z[sim_node()]].nextHop = __nesc_ntoh_uint8(rrm->sender.nxdata);
                __nesc_hton_uint8(rrm->data.nxdata, __nesc_ntoh_uint8(rrm->data.nxdata) + 1);
                __nesc_hton_uint8(rrm->sender.nxdata, TOS_NODE_ID);
                RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, 2);
              }
  ...
  if (__nesc_ntoh_uint8(rrm->type.nxdata) == 0 && !RadioRouteC$fine[sim_node()]) 
    {
      RadioRouteC$trovato[sim_node()] = FALSE;
      if (TOS_NODE_ID == 7) 
        {
          RadioRouteC$fine[sim_node()] = TRUE;
          sim_log_debug_clear(178U, "radio_rec", "\n");
          sim_log_debug(179U, "radio_rec", "----- Il pacchetto è arrivato a destinazione -----\n");
          sim_log_debug(180U, "radio_rec", "Type: %d\n", __nesc_ntoh_uint8(rrm->type.nxdata));
          sim_log_debug(181U, "radio_rec", "Sender: %d\n", __nesc_ntoh_uint8(rrm->sender.nxdata));
          sim_log_debug(182U, "radio_rec", "Receiver: %d\n", __nesc_ntoh_uint8(rrm->dest.nxdata));
          sim_log_debug(183U, "radio_rec", "Value: %d\n\n", __nesc_ntoh_uint8(rrm->data.nxdata));
        }
      RadioRouteC$r[sim_node()] = 0;
      while (RadioRouteC$r[sim_node()] < 7 && RadioRouteC$trovato[sim_node()] == FALSE) 
        {
          if (RadioRouteC$routingTable[sim_node()][RadioRouteC$r[sim_node()]].destAddress == __nesc_ntoh_uint8(rrm->dest.nxdata)) 
            {
              RadioRouteC$trovato[sim_node()] = TRUE;
              __nesc_hton_uint8(rrm->sender.nxdata, TOS_NODE_ID);
              RadioRouteC$destinazione[sim_node()] = RadioRouteC$routingTable[sim_node()][RadioRouteC$r[sim_node()]].nextHop;
              RadioRouteC$generate_send(RadioRouteC$destinazione[sim_node()], bufPtr, 0);
              sim_log_debug(184U, "radio_send", "<<<<< Sending packet in the route found from %d to %d \n", TOS_NODE_ID, RadioRouteC$routingTable[sim_node()][RadioRouteC$r[sim_node()]].nextHop);
            }
          RadioRouteC$r[sim_node()] = RadioRouteC$r[sim_node()] + 1;
        }
    }
  return bufPtr;
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76d5ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76d5ac8) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76d5ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76d3178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76d3178, msg, payload, len);
#line 78
...
static inline void RadioRouteC$AMControl$startDone(error_t err)
{
  if (err == SUCCESS) 
    {
      sim_log_debug(150U, "boot", "Radio ON on node %d!\n", TOS_NODE_ID);
      RadioRouteC$Timer1$startOneShot(5000);
    }
  else 
    {
      sim_log_error(151U, "boot", "Radio failed to start, retrying...\n");
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76d5108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76d5108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb75086a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb75086a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb75086a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb788f650){
#line 75
  switch (arg_0xb788f650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb788f650);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb75070a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb75070a0, addr, msg, len);
#line 80
...
static inline bool RadioRouteC$actual_send(uint16_t address, message_t *packet)
{
  ...
  if (RadioRouteC$locked[sim_node()]) 
    ...
    {
      radio_route_msg_t *rrm = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(packet, sizeof(radio_route_msg_t ));

#line 191
      if (rrm == (void *)0) 
        {
          sim_log_debug(148U, "radio", "Error, empty message!\n");
          return FALSE;
        }
...
static inline void RadioRouteC$fillRoutingTable(void )
{
  RadioRouteC$i[sim_node()] = 0;
  while (RadioRouteC$i[sim_node()] < 7) 
    {
      RadioRouteC$routingTable[sim_node()][RadioRouteC$i[sim_node()]].destAddress = 0;
      RadioRouteC$routingTable[sim_node()][RadioRouteC$i[sim_node()]].nextHop = 0;
      RadioRouteC$routingTable[sim_node()][RadioRouteC$i[sim_node()]].cost = 0;
      RadioRouteC$i[sim_node()] = RadioRouteC$i[sim_node()] + 1;
    }
}
...
static inline void RadioRouteC$Timer1$fired(void )
{
  sim_log_debug(153U, "timer", "Timer 1 started!\n");

  RadioRouteC$fillRoutingTable();
...
#line 247
      ...
      __nesc_hton_uint8(rrm->dest.nxdata, 7);
      RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], __nesc_ntoh_uint8(rrm->type.nxdata));
      sim_log_debug(154U, "radio_send", "Sending packet from node 1...\n");
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73893a8){
#line 83
  switch (arg_0xb73893a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73893a8);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(228U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(227U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(224U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(225U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(217U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(207U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(213U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(214U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(219U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
static uint8_t RadioRouteC$routeTableCheck(uint16_t dest)
{
  RadioRouteC$p[sim_node()] = 0;
  while (RadioRouteC$p[sim_node()] < 7) 
    {
      if (RadioRouteC$routingTable[sim_node()][RadioRouteC$p[sim_node()]].destAddress == dest) 
        {
          return RadioRouteC$p[sim_node()];
        }
      if (RadioRouteC$p[sim_node()] == 6) 
        {
          return 9;
        }
      RadioRouteC$p[sim_node()] = RadioRouteC$p[sim_node()] + 1;
    }
}
...
#line 285
  ...
  sim_log_debug(216U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(222U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
static void RadioRouteC$AMSend$sendDone(message_t *bufPtr, error_t error)
{
  ...
  if (&RadioRouteC$queued_packet[sim_node()] == bufPtr && error == SUCCESS) 
    {
      sim_log_debug(185U, "radio_send", "Packet sent successfully at time %s \n", sim_time_string());
      RadioRouteC$locked[sim_node()] = FALSE;
    }
  else 
    {
      sim_log_error(186U, "radio_send", "Send error !!!\n");
    }
}
...
#line 101
      sim_log_debug(202U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(203U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(204U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(205U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(223U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(226U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(215U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "RadioRouteC$index_led"))
  {
    *addr = (uintptr_t)&RadioRouteC$index_led[__nesc_mote];
    *size = sizeof(RadioRouteC$index_led[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$num_msg"))
  {
    *addr = (uintptr_t)&RadioRouteC$num_msg[__nesc_mote];
    *size = sizeof(RadioRouteC$num_msg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$trovato"))
  {
    *addr = (uintptr_t)&RadioRouteC$trovato[__nesc_mote];
    *size = sizeof(RadioRouteC$trovato[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$check"))
  {
    *addr = (uintptr_t)&RadioRouteC$check[__nesc_mote];
    *size = sizeof(RadioRouteC$check[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$t"))
  {
    *addr = (uintptr_t)&RadioRouteC$t[__nesc_mote];
    *size = sizeof(RadioRouteC$t[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "RadioRouteC$z"))
  {
    *addr = (uintptr_t)&RadioRouteC$z[__nesc_mote];
    *size = sizeof(RadioRouteC$z[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$i"))
  {
    *addr = (uintptr_t)&RadioRouteC$i[__nesc_mote];
    *size = sizeof(RadioRouteC$i[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$k"))
  {
    *addr = (uintptr_t)&RadioRouteC$k[__nesc_mote];
    *size = sizeof(RadioRouteC$k[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$p"))
  {
    *addr = (uintptr_t)&RadioRouteC$p[__nesc_mote];
    *size = sizeof(RadioRouteC$p[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$r"))
  {
    *addr = (uintptr_t)&RadioRouteC$r[__nesc_mote];
    *size = sizeof(RadioRouteC$r[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$resto"))
  {
    *addr = (uintptr_t)&RadioRouteC$resto[__nesc_mote];
    *size = sizeof(RadioRouteC$resto[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$destinazione"))
  {
    *addr = (uintptr_t)&RadioRouteC$destinazione[__nesc_mote];
    *size = sizeof(RadioRouteC$destinazione[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$firstdestination"))
  {
    *addr = (uintptr_t)&RadioRouteC$firstdestination[__nesc_mote];
    *size = sizeof(RadioRouteC$firstdestination[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$count_path_received_node_1"))
  {
    *addr = (uintptr_t)&RadioRouteC$count_path_received_node_1[__nesc_mote];
    *size = sizeof(RadioRouteC$count_path_received_node_1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$min_count_path_received_node_1"))
  {
    *addr = (uintptr_t)&RadioRouteC$min_count_path_received_node_1[__nesc_mote];
    *size = sizeof(RadioRouteC$min_count_path_received_node_1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$sender_min_count_path_received_node_1"))
  {
    *addr = (uintptr_t)&RadioRouteC$sender_min_count_path_received_node_1[__nesc_mote];
    *size = sizeof(RadioRouteC$sender_min_count_path_received_node_1[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "RadioRouteC$fine"))
  {
    *addr = (uintptr_t)&RadioRouteC$fine[__nesc_mote];
    *size = sizeof(RadioRouteC$fine[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memcpy((void *)&RadioRouteC$leader_code[__nesc_mote], (void *)&(unsigned short [8]){ 1, 0, 7, 7, 5, 1, 0, 5 }, sizeof RadioRouteC$leader_code[__nesc_mote]);
  memset((void *)&RadioRouteC$index_led[__nesc_mote], 0, sizeof RadioRouteC$index_led[__nesc_mote]);
  RadioRouteC$num_msg[__nesc_mote] = 0;
  memset((void *)&RadioRouteC$trovato[__nesc_mote], 0, sizeof RadioRouteC$trovato[__nesc_mote]);
  memset((void *)&RadioRouteC$check[__nesc_mote], 0, sizeof RadioRouteC$check[__nesc_mote]);
  memset((void *)&RadioRouteC$t[__nesc_mote], 0, sizeof RadioRouteC$t[__nesc_mote]);
  memset((void *)&RadioRouteC$j[__nesc_mote], 0, sizeof RadioRouteC$j[__nesc_mote]);
  memset((void *)&RadioRouteC$z[__nesc_mote], 0, sizeof RadioRouteC$z[__nesc_mote]);
  memset((void *)&RadioRouteC$i[__nesc_mote], 0, sizeof RadioRouteC$i[__nesc_mote]);
  memset((void *)&RadioRouteC$k[__nesc_mote], 0, sizeof RadioRouteC$k[__nesc_mote]);
  memset((void *)&RadioRouteC$p[__nesc_mote], 0, sizeof RadioRouteC$p[__nesc_mote]);
  memset((void *)&RadioRouteC$r[__nesc_mote], 0, sizeof RadioRouteC$r[__nesc_mote]);
  memset((void *)&RadioRouteC$resto[__nesc_mote], 0, sizeof RadioRouteC$resto[__nesc_mote]);
  memset((void *)&RadioRouteC$destinazione[__nesc_mote], 0, sizeof RadioRouteC$destinazione[__nesc_mote]);
  memset((void *)&RadioRouteC$firstdestination[__nesc_mote], 0, sizeof RadioRouteC$firstdestination[__nesc_mote]);
  memset((void *)&RadioRouteC$count_path_received_node_1[__nesc_mote], 0, sizeof RadioRouteC$count_path_received_node_1[__nesc_mote]);
  RadioRouteC$min_count_path_received_node_1[__nesc_mote] = 255;
  memset((void *)&RadioRouteC$sender_min_count_path_received_node_1[__nesc_mote], 0, sizeof RadioRouteC$sender_min_count_path_received_node_1[__nesc_mote]);
  ...
  RadioRouteC$fine[__nesc_mote] = FALSE;
