...
#line 135
              __nesc_hton_uint8(msg->topic.nxdata, TOS_NODE_ID % 3);
              __nesc_hton_uint8(msg->data.nxdata, TOS_NODE_ID % 4 * 10);
              __nesc_hton_uint8(msg->type.nxdata, 4);
              __nesc_hton_uint8(msg->dest.nxdata, 1);
              __nesc_hton_uint8(msg->sender.nxdata, TOS_NODE_ID);
              if (__nesc_ntoh_uint8(msg->topic.nxdata) == 0) {
#line 140
                sim_log_debug(161U, "radio_rec", "PUBLISH, topic: TEMPERATURE payload: %d\n", __nesc_ntoh_uint8(msg->data.nxdata));
                }
              else {
#line 141
                if (__nesc_ntoh_uint8(msg->topic.nxdata) == 1) {
...
#line 142
                  if (__nesc_ntoh_uint8(msg->topic.nxdata) == 2) {
#line 142
                    sim_log_debug(163U, "radio_rec", "PUBLISH, topic: LUMINOSITY payload: %d\n", __nesc_ntoh_uint8(msg->data.nxdata));
                    }
                  }
                }
#line 143
          ...
          if (__nesc_ntoh_uint8(msg->type.nxdata) == 4) 
            {
              if (__nesc_ntoh_uint8(msg->topic.nxdata) == 0) {
#line 174
                sim_log_debug(168U, "radio_rec", "PAN -> received PUB from node: %d, to topic: TEMPERATURE with payload: %d\n", __nesc_ntoh_uint8(msg->sender.nxdata) - 1, __nesc_ntoh_uint8(msg->data.nxdata));
                }
              else {
#line 175
                if (__nesc_ntoh_uint8(msg->topic.nxdata) == 1) {
#line 175
                  sim_log_debug(169U, "radio_rec", "PAN -> received PUB from node: %d, to topic: HUMIDITY with payload: %d\n", __nesc_ntoh_uint8(msg->sender.nxdata) - 1, __nesc_ntoh_uint8(msg->data.nxdata));
                  }
                else {
#line 176
                  if (__nesc_ntoh_uint8(msg->topic.nxdata) == 2) {
#line 176
                    sim_log_debug(170U, "radio_rec", "PAN -> received PUB from node: %d, to topic: LUMINOSITY with payload: %d\n", __nesc_ntoh_uint8(msg->sender.nxdata) - 1, __nesc_ntoh_uint8(msg->data.nxdata));
                    }
                  }
                }
#line 177
              ...
              if (connect(Project1C$sockfd[sim_node()], (struct sockaddr *)&Project1C$servaddr[sim_node()], sizeof Project1C$servaddr[sim_node()]) != 0) 
                {
                  sim_log_error(174U, "tcp", "Connection with the server failed!\n");
              ...
              if (send(Project1C$sockfd[sim_node()], msg, sizeof(msg_t ), 0) == -1) 
                {
                  sim_log_error(175U, "tcp", "Failed to send message!\n");
                  return;
                }
              close(Project1C$sockfd[sim_node()]);
            }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7656298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7656298) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7656298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74190a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74190a0, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76658b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76658b0, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7656930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7656930, msg, payload, len);
#line 78
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb741a6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb741a6a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb741a6a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb729b3a8){
#line 83
  switch (arg_0xb729b3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb729b3a8);
#line 83
      break;
#line 83
    }
  ...
  if ((indexConnReceived[TOS_NODE_ID - 2] == 0 || indexConnAckReceived[TOS_NODE_ID - 2] == 0) && TOS_NODE_ID != 1) 
    {
      ...
      sim_log_debug(176U, "radio_send", "PACKET LOST...send AGAIN CONN to PAN coordinator\n");
      __nesc_hton_uint8(msg->type.nxdata, 0);
      __nesc_hton_uint8(msg->sender.nxdata, TOS_NODE_ID);
      Project1C$AMSend$send(1, &Project1C$packet[sim_node()], sizeof(msg_t ));
    }
