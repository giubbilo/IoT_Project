      ...
      if (TOS_NODE_ID != 1) 
        {
          ...
          if (__nesc_ntoh_uint8(msg->type.nxdata) == 3 && indexSubAckReceived[__nesc_ntoh_uint8(msg->dest.nxdata) - 2] == 0) 
            {
              sim_log_debug(155U, "radio_rec", "Received SUBACK from PAN coordinator! Node: %d subbed!\n", TOS_NODE_ID - 1);
...
#line 118
          ...
          if (__nesc_ntoh_uint8(msg->type.nxdata) == 2) 
            {
              sim_log_debug(158U, "radio_rec", "PAN -> received SUB from node: %d\n", __nesc_ntoh_uint8(msg->sender.nxdata) - 1);
              indexSubReceived[__nesc_ntoh_uint8(msg->sender.nxdata) - 2] = __nesc_ntoh_uint8(msg->sender.nxdata) - 1;
              sim_log_debug(159U, "radio_send", "PAN -> sending SUBACK to node: %d\n", __nesc_ntoh_uint8(msg->sender.nxdata) - 1);
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74b02b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74b02b0, addr, msg, len);
#line 80
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74b18a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74b18a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74b18a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73303a8){
#line 83
  switch (arg_0xb73303a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73303a8);
#line 83
      break;
#line 83
    }
...
#line 140
  ...
  if (indexConnReceived[TOS_NODE_ID - 2] == 0 && TOS_NODE_ID != 1) 
    {
      sim_log_debug(160U, "radio_send", "PACKET LOST! Sending again a CONN message to PAN\n");
      __nesc_hton_uint8(msg->type.nxdata, 0);
      __nesc_hton_uint8(msg->sender.nxdata, TOS_NODE_ID);
      __nesc_hton_uint8(msg->dest.nxdata, 1);
      Project1C$AMSend$send(__nesc_ntoh_uint8(msg->dest.nxdata), &Project1C$packet[sim_node()], sizeof(msg_t ));
  ...
  if (TOS_NODE_ID != 1 && indexConnAckReceived[TOS_NODE_ID - 2] == 0 && indexConnReceived[TOS_NODE_ID - 2] != 0) 
    {
      ...
      sim_log_debug(161U, "radio_send", "PACKET LOST! Sending again a CONNACK message\n");
      Project1C$AMSend$send(__nesc_ntoh_uint8(msg->dest.nxdata), &Project1C$packet[sim_node()], sizeof(msg_t ));
    }
  if (TOS_NODE_ID != 1 && indexSubAckReceived[TOS_NODE_ID - 2] == 0 && indexSubReceived[TOS_NODE_ID - 2] != 0 && indexConnAckReceived[TOS_NODE_ID - 2] != 0 && indexConnReceived[TOS_NODE_ID - 2] != 0) 
    {
      ...
      __nesc_hton_uint8(msg->sender.nxdata, 1);
      __nesc_hton_uint8(msg->dest.nxdata, TOS_NODE_ID);
      sim_log_debug(162U, "radio_send", "PACKET LOST! Sending again a SUBACK message\n");
      Project1C$AMSend$send(__nesc_ntoh_uint8(msg->dest.nxdata), &Project1C$packet[sim_node()], sizeof(msg_t ));
    }
...
#line 175
        sim_log_debug(163U, "radio_send", "Sending a SUBSCRIBE message to topic: TEMPERATURE\n");
        }
      else {
#line 176
        if (__nesc_ntoh_uint8(msg->topic.nxdata) == 1) {
#line 176
          sim_log_debug(164U, "radio_send", "Sending a SUBSCRIBE message to topic: HUMIDITY\n");
          }
        else {
#line 177
          if (__nesc_ntoh_uint8(msg->topic.nxdata) == 2) {
#line 177
            sim_log_debug(165U, "radio_send", "Sending a SUBSCRIBE message to topic: LUMINOSITY\n");
            }
          }
        }
#line 178
