...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b9d458, const void *arg_0xb7b9d5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b4e8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79f8840), 
int (*key_eq_fn)(void *arg_0xb79f8c88, void *arg_0xb79f8e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78c79b8, int arg_0xb78c7b10);
static double RandomUniform(void );
...
#line 68
    {
      ...
      if (TOS_NODE_ID == 1 && __nesc_ntoh_uint8(rcm->type.nxdata) == 0) {
          sim_log_debug(155U, "radio_rec", "Received ACK from node: %d\n", __nesc_ntoh_uint8(rcm->sender.nxdata) - 1);
...
#line 85
              printf("%u ", indexAckReceived[RadioTossC$i[sim_node()]]);
            }
#line 85
          printf("\n");
        }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74e6730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74e6730, addr, msg, len);
#line 80
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74e9ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74e9ca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74e9ca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7823650){
#line 75
  switch (arg_0xb7823650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7823650);
#line 75
      break;
#line 75
    }
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73683a8){
#line 83
  switch (arg_0xb73683a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73683a8);
#line 83
      break;
#line 83
    }
...
#line 91
{
  ...
  if (&RadioTossC$packet[sim_node()] == bufPtr && error == SUCCESS) {
      sim_log_debug(157U, "radio_send", "Packet sent...\n");
      RadioTossC$locked[sim_node()] = TRUE;
    }
  if (indexAckReceived[TOS_NODE_ID - 2] == 0 && TOS_NODE_ID != 1) {
      sim_log_debug(158U, "radio_send", "PACKET LOST...send AGAIN ACK to PAN coordinator\n");
