...
uint16_t RadioTossC$indexConnected[1000][8];
...
#line 71
      if (TOS_NODE_ID == 1 && __nesc_ntoh_uint8(rcm->type.nxdata) == 0) {
          sim_log_debug(154U, "radio_rec", "Received ACK from %d\n", __nesc_ntoh_uint8(rcm->sender.nxdata) - 1);
          RadioTossC$indexConnected[sim_node()][__nesc_ntoh_uint8(rcm->sender.nxdata) - 2] = __nesc_ntoh_uint8(rcm->sender.nxdata) - 1;

          for (RadioTossC$i[sim_node()] = 0; RadioTossC$i[sim_node()] < 8; ++RadioTossC$i[sim_node()]) {
              printf("%u ", RadioTossC$indexConnected[sim_node()][RadioTossC$i[sim_node()]]);
            }
          printf("\n");
        }
      return bufPtr;
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb766eac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb766eac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb766eac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb766b178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb766b178, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb766e108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb766e108, msg, error);
#line 110
}
#line 110
...
#line 54
      ...
      if (RadioTossC$AMSend$send(1, &RadioTossC$packet[sim_node()], sizeof(radio_toss_msg_t )) == SUCCESS) {
...
#line 84
{
  if (&RadioTossC$packet[sim_node()] == bufPtr && error == SUCCESS) {
      sim_log_debug(155U, "radio_send", "Packet sent...\n");
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "RadioTossC$indexConnected"))
  {
    *addr = (uintptr_t)&RadioTossC$indexConnected[__nesc_mote];
    *size = sizeof(RadioTossC$indexConnected[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memcpy((void *)&RadioTossC$indexConnected[__nesc_mote], (void *)&(unsigned short [8]){ 0, 0, 0, 0, 0, 0, 0, 0 }, sizeof RadioTossC$indexConnected[__nesc_mote]);
